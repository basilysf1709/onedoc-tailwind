...
export const CV = () => { return (
    <Tailwind>
        ...
        <div className="main flex flex-col font-[Mulish]">
         ...
         <div className="contact flex p-[15px] justify-evenly border-black border-b-2 font-semibold">
             <div className="mail flex items-center mr-[15px]">
                 <MdEmail className="text-2xl text-[#0a66c2] mr-[4px]"/>
                 <span>johndoe@gmail.com</span>
             </div>
             <div className="location flex  items-center mr-[15px]">
                 <MdLocationOn className="text-2xl text-[#0a66c2] mr-[2px]" />
         ...
         <div className="skills p-[15px] flex flex-col  border-black border-b-2">
             <span className="text-2xl text-[#0a66c2] font-bold mb-[5px]">SKILLS</span>
         ...
         <div className="work-exp p-[15px] flex flex-col ] border-black border-b-2">
             ...
             <div className="wexp-1 flex flex-col ">
                 ...
                 <div className="what-he-did flex flex-col text-lg  mb-[20px]">
             ...
             <div className="wexp-2 flex flex-col ">
                 ...
                 <div className="what-he-did flex flex-col text-lg">
                     <div className="w1 flex mb-[5px]">
                         <span className="text-[#0a66c2]">-</span>
         ...
         <div className="organizations p-[15px] flex flex-col ] border-black border-b-2">
             <span className="text-2xl text-[#0a66c2] font-bold mb-[5px]">ORGANIZATIONS</span>
             <div className="flex-wrap flex justify-between text-xl font-semibold">
         ...
         <div className="languages p-[15px] flex flex-col">
             <span className="text-2xl text-[#0a66c2] font-bold mb-[5px]">LANGUAGES</span>
             <div className="what-are-the-lang flex font-semibold justify-evenly text-xl">
                 <div className="lang1 flex flex-col mr-[24px]">
                     <span>English</span>
                     <span className="text-md text-[#0a66c2]"><i>Native or Bilingual Proficiency</i></span>
                 </div>
                 <div className="lang2 flex flex-col mr-[24px]">
                     <span>Spanish</span>
